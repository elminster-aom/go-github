...
type SCIMEnterpriseUserAttributes struct {
	...
	Name        SCIMEnterpriseUserName           `json:"name"`        // The user's full name
	...
	Roles       []SCIMEnterpriseUserRole         `json:"roles"`       // List of the user's roles.
	...
	Groups      []SCIMEnterpriseDisplayReference `json:"groups"`      // List of groups who are assigned to the user in SCIM provider
...
type SCIMEnterpriseUserName struct {
	...
	Formatted  string `json:"formatted"`  // The user's full name, including all middle names, titles, and suffixes, formatted for display.
}
...
type SCIMEnterpriseUserEmail struct {
	...
	Primary *bool   `json:"primary,omitempty"` // Whether this email address is the primary address.
	Type    *string `json:"type,omitempty"`    // The type of email address
}
...
// SCIMProvisionedIdentities represents the result of calling ProvisionSCIMEnterpriseUser.
